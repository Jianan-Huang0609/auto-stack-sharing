...
按 Discord SAM 2026-05-12 晚间记录校正：
- Jianan 不喜欢纯白底 / 米白底。
- 想要更好看的彩色。
- beautiful-html-templates 的彩色方向可以学习。
- 要和现有 auto-stack-sharing 的 teal / orange / warm pop / mono 标签 / 高密度卡片和谐。
- 方向：warm colorful + graphic + structured。
- 参考：Creative Mode / BlockFrame / Capsule。
- 不走黑紫，不走纯白米白，不要幼稚，要“彩色的系统感”。

注意：我之前说“回到暖白底 + 橙主色”不够准确，会误导后续设计。正确方向是“彩色系统感 + 高密度内容骨架 + 高审美视觉皮肤”。
...
4. 具体采用 beautiful-html-templates 哪一类彩色模板语言：Creative Mode / BlockFrame / Capsule 中哪一个为主？
